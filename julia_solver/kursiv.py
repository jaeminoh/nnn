...
np.savez("Kursiv/data/etdrk.npz", tt=tt, sol=uu)

plt.imshow(
    uu, aspect="auto", cmap="jet", extent=[0, 32 * np.pi, 0, tmax]
)
plt.xlabel(r"$x$")
plt.ylabel(r"$t$")
plt.colorbar()
plt.tight_layout()
plt.savefig("Kursiv/results/kursiv.pdf", format="pdf")